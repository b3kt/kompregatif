    ...
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}" class="btn btn-primary btn-add-new">
                <i class="voyager-plus"></i> <span>{{ __('simanis.button.create_instance') }}</span>
            </a>
        @endcan
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions text-right">
                                            {{-- @foreach($actions as $action)
                                                ...
                                                @endif
                                            @endforeach --}}
                                            <a href="{{ route('voyager.'.$dataType->slug.'.fill', ['id'=>$data->id]) }}" class="btn btn-primary btn-add-new">
                                                <i class="voyager-pencil"></i> <span>{{ __('simanis.button.fill_form') }}</span>
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
